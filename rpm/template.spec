...
%global pkg_name trac_ik_kinematics_plugin
%global normalized_pkg_name %{lua:return (string.gsub(rpm.expand('%{pkg_name}'), '_', '-'))}

Name:           ros-lyrical-trac-ik-kinematics-plugin
Version:        2.2.0
Release:        3%{?dist}
...
%changelog
* Wed Apr 29 2026 TRACLabs Robotics <robotics@traclabs.com> - 2.2.0-3
- Autogenerated by Bloom

* Tue Apr 28 2026 TRACLabs Robotics <robotics@traclabs.com> - 2.2.0-2
- Autogenerated by Bloom

* Tue Apr 21 2026 TRACLabs Robotics <robotics@traclabs.com> - 2.2.0-1
- Autogenerated by Bloom
